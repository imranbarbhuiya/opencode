...
- **Review inline**: On pull requests, OpenCode posts findings as a GitHub review with line comments and optional `suggestion` blocks, not only a conversation comment.
